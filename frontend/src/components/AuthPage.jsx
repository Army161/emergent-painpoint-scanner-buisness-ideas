    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      ...
      <div className="animate-fade-up" style={{ width: '100%', maxWidth: 420, position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ margin: 0, fontSize: 22, fontWeight: 700, color: 'var(--text)', fontFamily: 'Plus Jakarta Sans' }}>IdeaRadar</h1>
          <p style={{ margin: '6px 0 0', fontSize: 14, color: 'var(--text-medium)' }}>The Bloomberg Terminal for startup ideas</p>
        </div>
        ...
        <div className="card" style={{ padding: 32 }}>
          ...
          <p style={{ textAlign: 'center', fontSize: 13, color: 'var(--subtle)', marginTop: 20 }}>
